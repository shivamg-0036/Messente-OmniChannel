...
export default function SMSDLTManagement(sidebarOpen) {
                                ...
                                <div className="card-body">
                                    <div className="media d-flex">
                                        <div className="align-self-center">
                                            <i className="fa-solid fa-user-check text-white float-left" style={{ fontSize: "1.8rem" }}></i>
                                        </div>
                                        <div className="media-body text-white text-right">
                                            <h3 className="text-white">278</h3>
                                            <span className='dlt-span'>Sender ID</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body">
                                    <div className="media d-flex">
                                        ...
                                        <div className="media-body text-white text-right">
                                            ...
                                            <span className='dlt-span'>Entity ID</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className='dlt-row'>
                ...
                {!isSenderExpanded && !isEntityExpanded && (<div className={`dlt-temp-card ${isExpanded ? 'expanded' : ''}`}>
                    <div class="row mb-0" style={{ display: "flex", justifyContent: "space-between", width: '100%' }}>
                        <div class="card-header" style={{ border: "none", display: "flex" }}>
                            <h5 class="card-title font-weight-bold" >DLT Templates</h5>
                            {/* <div style={{ cursor: "pointer" }} >
                                <span class="badge badge-glow badge-pill badge-success badge-square ml-2" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem" }}>
                                    <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add Templates
                                </span>
                            </div> */}
                        </div>

                        <div className='mr-2' style={{ display: "flex", height: "100%", alignItems: "center", margin: "auto" }} >
                            <div style={{ cursor: "pointer", marginTop:"0.1rem" }} >
                                <span class="badge badge-glow badge-pill badge-success badge-square" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem", marginRight:"1.6rem" }}>
                                    <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add
                                </span>
                            </div>
                    ...
                    <div className={`collapsible-wrapper ${isCollapsed ? 'collapsed' : ''} ml-2  mr-2`} style={{ width: "100%" }}>
                        <div className={`collapsible-container ${isCollapsed ? 'collapsed' : 'expanded'} `} style={{ width: "100%" }}>
                            <div className='row ' style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                                ...
                                <div style={{ width: "70%", display: "flex", justifyContent: "flex-end", columnGap: "2rem" }}>
                                    <SelectBox
                                        label=""
                                        options={[
                                        ...
                                        widthPercent="32%" widthPercent950="32%" widthPercent900="35%"
                                ...
                                <div style={{ width: "100%", overflowX: "auto" }} className='table-dlt-div'>
                                    <Table
                                        columns={[
                                            ...
                                            { key: "templatecontent", label: "TEMPLATE CONTENT" },
                                            { key: "createdate", label: "CREATED DATE  (IST)" },
                        ...
                        {!isEntityExpanded && (<div className={`div-small-card-1 ${isSenderExpanded ? 'expanded' : ''}`}>
                            <div class="row mb-0" style={{ display: "flex", justifyContent: "space-between", width: '100%', alignItems: "center" }}>
                                <div class="card-header" style={{ border: "none", display: "flex", alignItems: 'center' }}>
                                    <h6 class="card-title font-weight-bold">Sender IDs</h6>
                                    <div class="badge badge-pill badge-border badge-glow border-warning warning badge-square ml-1">
                                        Total: 97
                                    </div>

                                    {/* <div style={{ cursor: "pointer" }} >
                                        <span class="badge badge-glow badge-pill badge-warning badge-square ml-2" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem", color: "white" }}>
                                            <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add Senders
                                        </span>
                                    </div> */}
                                </div>
                                
                                <div style={{ cursor: "pointer", marginRight:"-10rem" }} >
                                        <span class="badge badge-glow badge-pill badge-warning badge-square" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem", color: "white" }}>
                                            <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add
                                        </span>
                                    </div> 
                                ...
                                <div className={`collapsible-container ${isSenderCollapsed ? 'collapsed' : 'expanded'} `} style={{ width: "100%" }}>
                                    ...
                                    <div className='row mx-3 ' style={{ display: "flex", alignItems: "center", justifyContent: 'flex-start', marginTop: "2.2rem", marginBottom: "2.2rem", rowGap: "0.8rem", columnGap: '0.6rem' }}>
                                        <div class="badge badge-pill badge-glow badge-info badge-square" style={{ margin: "auto", paddingTop: "0.7rem", paddingBottom: "0.5rem" }}>
                                            <span style={{ paddingTop: "0.3rem" }}>ABCDEFG</span>
                                        </div>
                                    ...
                                    <div className='row mx-2 mb-1' style={{ borderTop: "1px solid #dddbdbff", alignItems: "center", justifyContent: "space-between" }}>
                                        <div style={{ fontSize: "0.8rem", marginTop: "1rem" }}>
                                            <span>Showing 1 to 20 of 47 results</span>
                                        </div>
                        ...
                        {!isSenderExpanded && (
                            <div className={`div-small-card-2 ${isEntityExpanded ? 'expanded' : ''}`}>
                                <div class="row mb-0" style={{ display: "flex", justifyContent: "space-between", width: '100%', height: "auto", alignItems: 'center' }}>
                                    <div class="card-header" style={{ border: "none", display: "flex", alignItems: 'center' }}>
                                        <h6 class="card-title font-weight-bold" >Entity IDs</h6>
                                        ...
                                        <div class="badge badge-pill badge-border badge-glow border-info info badge-square ml-1">
                                         ...
                                         {/* <div style={{ cursor: "pointer" }} >
                                        <span class="badge badge-glow badge-pill badge-info badge-square ml-2" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem", color: "white" }}>
                                            <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add Entity ID
                                        </span>
                                    </div> */}
                                    </div>

                                    <div style={{ cursor: "pointer", marginRight:"-10.5rem" }} >
                                        <span class="badge badge-glow badge-pill badge-info badge-square" style={{ padding: "0.5rem 0.4rem", paddingRight: "0.5rem", color: "white" }}>
                                            <i className="fa solid fa-plus" style={{ marginRight: "0.2rem" }}></i>  Add
                                        </span>
                                    </div> 
                                            ...
                                            <div className="card-content ">
                                                <div className="card-body card-dashboard" style={{ padding: "0" }}>
                                                    <div className="row">
                                                        ...
                                                        >
                                                            <p className="text-muted mb-0">ENTITY ID</p>
